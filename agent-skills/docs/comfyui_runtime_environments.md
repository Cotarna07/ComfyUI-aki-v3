...
| `wan-video-py313-cu130` | 8189 | Wan 视频节点测试 | 已创建 |
...
| `ltx-video-py313-cu130` | 8193 | LTX/LX 视频、导演、修复、音频潜空间节点测试 | 已创建 |
...
- Wan 2.x、WanVideoWrapper、K3NK、Wan SVI、Wan 透明视频优先走 `wan-video-py313-cu130`。
- LTX/LX、LTX 2.x、LTX Director、LTX IC-LoRA、LTX 音频潜空间、基于 LTX 的去水印/字幕/模糊修复优先走 `ltx-video-py313-cu130`。
...
- 在 `http://127.0.0.1:8193` 里点安装，会装到 `ltx-video-py313-cu130`。
