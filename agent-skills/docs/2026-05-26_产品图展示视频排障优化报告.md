...
| 工作流 | 路径 | 状态 |
|--------|------|------|
| Wan 2.2 I2V | `agent-skills/comfyui/workflows/01-shared/` | 待导出 |
| Wan 2.2 I2V Portrait | `agent-skills/comfyui/workflows/01-shared/wan22_i2v_portrait_preview.json` | ✅ 已有 |
...
| 工作流 | `agent-skills/comfyui/workflows/01-shared/wan22_i2v_direct_preview.json` |
